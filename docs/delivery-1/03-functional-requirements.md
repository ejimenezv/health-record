...
| **Trazabilidad** | OBJ-002: Optimizar costos manteniendo respuesta real-time |
...
| **Dependencias** | RF-004, RF-012 (RAG), RF-017 (Notificaciones real-time) |
...
|-----------|----------|-----|
| Alta | 17 | RF-001 a RF-014, RF-016, RF-017, RF-008-A, RF-008-B |
| Media | 2 | RF-015, RF-018 |
| Baja | 0 | - |
...
| OBJ-003: Generar documentación estructurada | RF-004, RF-005, RF-006, RF-007, RF-008, RF-008-A |
| OBJ-004: Mejorar calidad de registros | RF-009, RF-012 |
| Calidad y precisión de datos | RF-008-B |
| Requisito BSG: Endpoints | RF-010, RF-011 |
| RNF: Seguridad | RF-014 |
| RNF: Observabilidad | RF-015 |
| Integración sistema existente | RF-016, RF-017 |
| Control de costos | RF-018 |
